...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='cbramod',
                        ...
                        help='backbone model: cbramod (CBraMod) or codebrain (CodeBrain SSSM)')
...
def main():
    ...
    print("=" * 60)
    model_name = 'CodeBrain (SSSM)' if params.model == 'codebrain' else 'CBraMod'
    ...
    if params.no_pretrained:
        ...
        if params.model == 'codebrain':
            pretrained_path = DEFAULT_CODEBRAIN_WEIGHTS_PATH
        else:
            pretrained_path = DEFAULT_WEIGHTS_PATH
