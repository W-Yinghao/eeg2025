...
# lr_head=1e-3, lr_backbone=1e-6, cosine scheduler, warmup=3, max_epochs=12
# early_stop_patience=4
#
# Usage:
#   sbatch run_exp6b_gpartial_p2_selector_jeanzay.sh [MODEL] [DATASET] [SEED]
#
...
SAVE_DIR="${PROJECT_DIR}/checkpoints_selector/exp6b_gpartial_p2_selector"
mkdir -p "$SAVE_DIR"

TAG="Exp6B_P2_selector_${MODEL}_${DATASET}_top1_lrbb1e-6_s${SEED}_$(date +%Y%m%d_%H%M%S)"

echo "=============================================="
echo "  Exp 6B P2: Gentle Partial Selector (lr_bb=1e-6)"
