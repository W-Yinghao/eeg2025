...
################################################################################
# Experiment 7C — Asymmetric Sparse + Consistency (gpu-gw)
#
# Design:
...
#
# Usage:
#   sbatch run_exp7c_asym_sparse_cons_selector.sh [MODEL] [DATASET] [SEED]
################################################################################
...
SCRIPT_PATH="${PROJECT_DIR}/experiments/deb/scripts/run_exp7c_asym_sparse_cons_selector.sh"
