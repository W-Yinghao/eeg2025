...
################################################################################
# DEB Fine-tune (single strategy) — Jean Zay version
#
# Usage:
#   sbatch run_deb_3ft_jeanzay.sh [MODEL] [DATASET] [FT_MODE] [SEED]
...
echo "=============================================="
echo "  DEB: ${MODEL} | ${DATASET} | ${FT_MODE} | seed=${SEED}"
echo "  Node: $(hostname)"
...
TAG="DEB_${MODEL}_${DATASET}_${FT_MODE}_s${SEED}_$(date +%Y%m%d_%H%M%S)"
