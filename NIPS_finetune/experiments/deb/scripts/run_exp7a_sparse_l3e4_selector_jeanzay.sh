...
################################################################################
# Experiment 7A — Frozen Selector + L1 Sparse (lambda=3e-4)
#
# Usage:
#   sbatch run_exp7a_sparse_l3e4_selector_jeanzay.sh [MODEL] [DATASET] [SEED]
################################################################################
...
SAVE_DIR="${PROJECT_DIR}/checkpoints_selector/exp7a_sparse_l3e4_selector"
LOG_DIR="${PROJECT_DIR}/deb_log/exp7a_sparse_l3e4_selector"
SCRIPT_PATH="${PROJECT_DIR}/experiments/deb/scripts/run_exp7a_sparse_l3e4_selector_jeanzay.sh"
mkdir -p "$SAVE_DIR" "$LOG_DIR"

TAG="Exp7A_sparse_l3e4_${MODE}_${MODEL}_${DATASET}_s${SEED}_$(date +%Y%m%d_%H%M%S)"
