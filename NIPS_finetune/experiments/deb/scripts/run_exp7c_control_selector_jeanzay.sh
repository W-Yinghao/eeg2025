...
################################################################################
# Experiment 7C-control — Light Sparse + Consistency (Jean Zay)
#
...
#
# Usage:
#   sbatch run_exp7c_control_selector_jeanzay.sh [MODEL] [DATASET] [SEED]
################################################################################
...
SCRIPT_PATH="${PROJECT_DIR}/experiments/deb/scripts/run_exp7c_control_selector_jeanzay.sh"
