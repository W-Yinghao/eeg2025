...
################################################################################
# Experiment 7A — Frozen Selector + L1 Sparse (lambda=1e-3)
#
# Usage:
#   sbatch run_exp7a_sparse_l1e3_selector_jeanzay.sh [MODEL] [DATASET] [SEED]
################################################################################
...
SAVE_DIR="${PROJECT_DIR}/checkpoints_selector/exp7a_sparse_l1e3_selector"
LOG_DIR="${PROJECT_DIR}/deb_log/exp7a_sparse_l1e3_selector"
SCRIPT_PATH="${PROJECT_DIR}/experiments/deb/scripts/run_exp7a_sparse_l1e3_selector_jeanzay.sh"
mkdir -p "$SAVE_DIR" "$LOG_DIR"

TAG="Exp7A_sparse_l1e3_${MODE}_${MODEL}_${DATASET}_s${SEED}_$(date +%Y%m%d_%H%M%S)"
