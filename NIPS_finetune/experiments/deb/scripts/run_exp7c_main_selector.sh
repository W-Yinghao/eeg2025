...
################################################################################
# Experiment 7C-main — Frozen Selector + Joint Sparse + Consistency (gpu-gw)
#
...
#
# Usage:
#   sbatch run_exp7c_main_selector.sh [MODEL] [DATASET] [SEED]
################################################################################
...
SCRIPT_PATH="${PROJECT_DIR}/experiments/deb/scripts/run_exp7c_main_selector.sh"
